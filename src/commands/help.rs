...
pub async fn help(ctx: &Context, msg: &Message, mut args: Args) -> CommandResult {
    ...
    msg.channel_id.send_message(&ctx.http, |m| {
        m.embed(|e| e
            .colour(0xffffff)
            .thumbnail("https://static.wikia.nocookie.net/disney/images/b/bd/Profile_-_Cogsworth.png/revision/latest?cb=20190317100043")
            .title("**- -【 Ｈｅｌｐ 】- -**")
            .description(format!("Ladies and gentlemen, I'm Rugsworth. A :rocket: blazing fast :rocket: rust :rocket: discord bot powered by :rocket: Serenity, Songbird and ChatGPT! :rocket: My prefix is `{}`", prefix))
            .fields(
                match menu_choice {
